                ...
                children: (0, t.jsx)("div", {
                  ...
                  children: (0, t.jsxs)("div", {
                    ...
                    children: [
                      (0, t.jsx)("h1", {
                        className:
                          "text-center text-[23px] bg-gradient-to-r from-purple-600 from-[10%] via-pink-600 via-[40%] to-pink-600 to-[85%] text-transparent bg-clip-text mt-4 ".concat(
                            l.className,
                            " font-[900]"
                          ),
                        children: "Presale - Buy ETHAI Now",
                      }),
                      (0, t.jsxs)("div", {
                        className:
                          "absolute inset-0 pointer-events-none overflow-hidden",
                        children: [
                          ...
                          (0, t.jsxs)("svg", {
                            className:
                              "absolute -top-8 -right-8 w-32 h-32 text-purple-800 opacity-20 animate-float",
                            fill: "currentColor",
                            viewBox: "0 0 128 128",
                            children: [
                              (0, t.jsx)("circle", {
                              ...
                              (0, t.jsx)("path", {
                                d: "M64,16 Q112,32 112,64 Q96,112 64,112 Q16,96 16,64 Q32,16 64,16 Z",
                                opacity: "0.5",
                              }),
                              (0, t.jsx)("rect", {
                                x: "48",
                          ...
                          (0, t.jsxs)("svg", {
                            className:
                              "absolute -bottom-6 -left-6 w-24 h-24 text-blue-800 opacity-25 animate-float-reverse",
                            fill: "currentColor",
                            viewBox: "0 0 96 96",
                            children: [
                              (0, t.jsx)("polygon", {
                          ...
                          (0, t.jsxs)("svg", {
                            className:
                              "absolute top-1/3 -left-4 w-16 h-16 text-pink-800 opacity-30 animate-float",
                            stroke: "currentColor",
                            fill: "none",
                            viewBox: "0 0 64 64",
                          ...
                          (0, t.jsxs)("svg", {
                            className:
                              "absolute bottom-1/4 -right-2 w-20 h-20 text-purple-700 opacity-20 animate-float-reverse",
                            fill: "currentColor",
                            viewBox: "0 0 80 80",
                            style: { animationDelay: "1s" },
                            children: [
                              (0, t.jsx)("path", {
                                d: "M40,5 L75,20 L75,60 L40,75 L5,60 L5,20 Z",
                              }),
                              (0, t.jsx)("circle", {
                                cx: "40",
                                cy: "40",
                          ...
                          (0, t.jsxs)("svg", {
                            className:
                              "absolute inset-0 w-full h-full opacity-5",
                            viewBox: "0 0 400 600",
                            fill: "none",
                            children: [
                              (0, t.jsx)("defs", {
                              ...
                              (0, t.jsx)("rect", {
                                width: "100%",
                                height: "100%",
                                fill: "url(#presaleGrid)",
                              }),
                            ],
                          }),
                          (0, t.jsx)("div", {
                            className:
                              "absolute top-8 right-12 w-2 h-2 bg-purple-400 rounded-full opacity-40 animate-pulse",
                          }),
                          (0, t.jsx)("div", {
                            className:
                              "absolute top-20 right-8 w-1.5 h-1.5 bg-blue-400 rounded-full opacity-50 animate-pulse",
                            style: { animationDelay: "1s" },
                          }),
                          (0, t.jsx)("div", {
                            className:
                              "absolute bottom-16 left-8 w-2 h-2 bg-pink-400 rounded-full opacity-30 animate-pulse",
                            style: { animationDelay: "2s" },
                          }),
                          (0, t.jsx)("div", {
                            className:
                              "absolute bottom-8 left-16 w-1 h-1 bg-purple-500 rounded-full opacity-60 animate-pulse",
                      ...
                      (0, t.jsxs)("div", {
                        ...
                        children: [
                          ...
                          (0, t.jsxs)("div", {
                            className:
                              "text-center mb-1 flex items-center gap-8",
                            children: [
                              (0, t.jsx)("hr", {
                                className:
                                  "border-gray-300 dark:border-gray-700 my-6 flex-grow flex-shrink",
                              }),
                              (0, t.jsxs)("span", {
                                className:
                          ...
                          (0, t.jsxs)("div", {
                            ...
                            children: [
                              (0, t.jsx)(i, { progressPercentage: W }),
                              (0, t.jsx)("div", {
                                className: "flex justify-center mt-2",
                                children: (0, t.jsxs)("span", {
                                  className:
                                    "text-sm lg:text-[15px] text-[#0B101C] font-semibold dark:text-gray-300",
                                  children: [
                                    "$",
                          ...
                          (0, t.jsx)("div", {
                            className:
                              "border-t border-gray-300 dark:border-gray-700 my-6",
                          }),
                          (0, t.jsxs)("div", {
                            className:
                              "flex flex-row justify-between items-center w-full bg-gray-200 dark:bg-gray-900 rounded-full h-7",
                            children: [
                              (0, t.jsx)("div", {
                                className:
                                  "w-6 h-6 bg-gradient-to-br from-yellow-400 to-orange-500 rounded-full flex items-center justify-center z-[100]",
                                children: (0, t.jsx)("svg", {
                              ...
                              (0, t.jsxs)("span", {
                                className:
                                  "text-xs text-[#0B101C] dark:text-gray-300 font-semibold ".concat(
                                    l.className
                                  ),
                                children: [
                                  " ",
                                  (0, t.jsxs)("p", {
                                    className:
                                      "text-sm text-[#0B101C] dark:text-white",
                                    children: [
                                      parseFloat(ea).toLocaleString("en-US", {
                              ...
                              (0, t.jsx)("div", {
                                className:
                                  "w-6 h-6 bg-gradient-to-br from-blue-400 to-purple-500 rounded-full flex items-center justify-center",
                                children: (0, t.jsx)("svg", {
                                  className: "w-3 h-3 text-white",
                                  fill: "currentColor",
                                  viewBox: "0 0 24 24",
                          ...
                          (0, t.jsxs)("div", {
                            className:
                              "text-center mt-2 flex items-center gap-8",
                            children: [
                              (0, t.jsx)("hr", {
                                className:
                                  "border-gray-300 dark:border-gray-700 my-6 flex-grow flex-shrink",
                                ...
                                children: [
                                  ...
                                  es
                                    ? "ETH" === A
                                      ? "".concat(
                                          parseFloat(
                                            new f.BigNumber(es.tokenPriceETH)
                                              .shiftedBy(-18)
                                              .toString()
                                          )
                                            .toFixed(9)
                          ...
                          (0, t.jsx)("div", {
                            className:
                              "border-gray-300 dark:border-gray-700 my-2",
                          }),
                          (0, t.jsxs)("div", {
                            ...
                            children: [
                              (0, t.jsxs)("button", {
                                onClick: () => eo("ETH"),
                                className:
                                  "flex items-center gap-2 px-4 py-2.5 border-2 rounded-lg transition-all duration-200 transform hover:scale-105 shadow-sm hover:shadow-md ".concat(
                                    "ETH" === A
                                ...
                                children: [
                                  (0, t.jsx)("div", {
                                    className:
                                      "w-5 h-5 bg-blue-600 rounded-full flex items-center justify-center text-white text-xs font-bold",
                                    children: (0, t.jsx)("svg", {
                                      className: "w-3 h-3",
                                      viewBox: "0 0 24 24",
                                      fill: "currentColor",
                          ...
                          (0, t.jsxs)("div", {
                            className:
                              "text-center mb-2 flex items-center gap-8",
                            children: [
                              (0, t.jsx)("hr", {
                                className:
                                  "border-gray-300 dark:border-gray-700 my-6 flex-grow flex-shrink",
                              ...
                              (0, t.jsxs)("p", {
                                className:
                                  "text-sm text-[#0B101C] dark:text-gray-300",
                                children: [
                                  A,
                                  " Balance: ",
                                  (0, t.jsx)("span", {
                          ...
                          (0, t.jsxs)("div", {
                            className:
                              "flex flex-row items-baseline mb-6 gap-2",
                            children: [
                              (0, t.jsxs)("div", {
                                children: [
                                  (0, t.jsxs)("label", {
                                    className:
                                      "block text-sm font-medium text-gray-900 dark:text-gray-300 mb-2",
                                    children: ["Pay with ", A],
                                  }),
                                  (0, t.jsxs)("div", {
                                    className: "relative",
                                      ...
                                      (0, t.jsx)("div", {
                                        ...
                                        children:
                                          "ETH" === A
                                            ...
                                            : (0, t.jsx)("div", {
                                                className:
                                                  "w-5 h-5 flex items-center justify-center token-icon usdt text-sm font-bold",
                                                children: (0, t.jsx)(
                                                  L.default,
                                                  {
                                                    src: "/images/usdt.webp",
                                  ...
                                  (0, t.jsxs)("div", {
                                    ...
                                    children: [
                                      (0, t.jsx)("input", {
                                        ...
                                        value: H,
                                        className:
                                          "w-full px-4 py-3 pr-12 bg-gradient-to-r from-gray-200 to-gray-300 dark:from-gray-900 dark:to-gray-900 border border-gray-300 dark:border-gray-600 rounded-lg text-gray-900 dark:text-white placeholder-gray-500 dark:placeholder-gray-400 text-lg font-medium cursor-not-allowed shadow-inner",
                                      }),
                                      (0, t.jsx)("div", {
                                        className:
                                          "absolute right-3 top-1/2 transform -translate-y-1/2",
                                        children: (0, t.jsx)("div", {
                                          className:
                                            "w-6 h-6 flex items-center justify-center etherchain-logo-container",
                                          children: (0, t.jsx)("img", {
                                            src: "/logo_alpha.webp",
                                            alt: "Etherchain Logo",
                                            className:
                                              "w-full h-full object-contain etherchain-logo",
                                          }),
                                        }),
                                      }),
                                    ],
                          ...
                          (0, t.jsx)("div", {
                            className:
                              "flex flex-col items-center justify-center mb-4 w-full",
                            children: (0, t.jsxs)("div", {
                              className:
                                "mb-1 w-full flex flex-col justify-center space-y-1",
                              children: [
                                s
                                  ? (() => {
                                      if (isNaN(I) || "" === I)
                          ...
                          (0, t.jsxs)("div", {
                            className:
                              "flex flex-col justify-center gap-4 text-sm",
                            children: [
                              (0, t.jsxs)("a", {
                                href: "/how-to-buy",
                                className:
                                  "text-ethai dark:text-ethai hover:text-purple-700 dark:hover:text-purple-300 font-medium text-center transition-colors",
                                children: [
                                  (0, t.jsx)(g.FontAwesomeIcon, {
                                    icon: b.faInfoCircle,
                                    className: "h-4 w-4",
